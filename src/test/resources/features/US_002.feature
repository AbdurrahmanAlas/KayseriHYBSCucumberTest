...
Feature: US_002 The appearance of the Home Page, Operation Module, Demand Lists, Water and Utilities Demand List links and the passage to the section related to the blocked AND are detected.
