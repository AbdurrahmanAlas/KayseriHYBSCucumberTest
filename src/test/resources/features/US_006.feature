  ...
  Feature: US_006 "When the user clicks on the 'Vehicle List' button in the Business Module, the functionalities on the page should work properly."
    ...
    @tc07
    Scenario: TC_0601 When the user clicks on the 'Vehicle List' button, the relevant page should appear. And the checkboxes for 'Transport Permit' and 'ATS Document' should be visible and clickable."
      ...
      * Test whether the checkbox has status or not.
      # burda kaldım hata var tekra r yaz
